...
class Player
{
    ...
    protected:
        sf::Texture* m_texture; ///< Player's texture
        sf::Texture* m_animTab[6]; ///< Array of the run textures
        sf::Texture* m_jumpTexture; ///< Player's jump texture
        sf::Texture* m_fallTexture; ///< Player's fall texture
        sf::Sprite* m_sprite; ///< Player's sprite
        sf::Sound* m_jumpSound; ///< Jump sound
        sf::SoundBuffer* m_jumpSoundBuffer; ///< Jump sound buffer
        sf::IntRect* m_rect; ///< Player's rect
        int m_dx; ///< Position x
        int m_dy; ///< Position y
